...
lexer.rules = [/^(?:('))/,/^(?:("))/,/^(?:([`]))/,/^(?:.*?(?=(')))/,/^(?:.*?(?=(")))/,/^(?:.*?(?=([`])))/,/^(?:([a-zA-Z0-9_-]+))/,/^(?:('))/,/^(?:("))/,/^(?:([`]))/,/^(?:([a-zA-Z0-9_-]+))/,/^(?:([=]))/,/^(?:\s+)/,/^(?:\s+)/,/^(?:$)/];
lexer.conditions = {"singleQuoteParameter":{"rules":[0,3,10,11,13,14],"inclusive":true},"doubleQuoteParameter":{"rules":[1,4,10,11,13,14],"inclusive":true},"angleQuoteParameter":{"rules":[2,5,10,11,13,14],"inclusive":true},"equals":{"rules":[6,7,8,9,10,11,12,13,14],"inclusive":true},"INITIAL":{"rules":[10,11,13,14],"inclusive":true}};
return lexer;})()
parser.lexer = lexer;
