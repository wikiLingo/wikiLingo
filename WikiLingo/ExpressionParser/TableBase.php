...
class TableBase
{
    ...
    function __construct()
    {
        //Setup Parser
			...
			$symbol3 = new ParserSymbol("grid", 3);
			$symbol4 = new ParserSymbol("rows", 4);
			$symbol5 = new ParserSymbol("EOF", 5);
			$symbol6 = new ParserSymbol("row", 6);
			$symbol7 = new ParserSymbol("END_OF_LINE", 7);
			$symbol8 = new ParserSymbol("END_OF_LINE_WITH_EMPTY_NEXT_FIRST_COLUMN", 8);
			$symbol9 = new ParserSymbol("END_OF_LINE_WITH_NO_COLUMNS", 9);
			$symbol10 = new ParserSymbol("END_OF_LINE_WITH_EMPTY_COLUMN", 10);
			$symbol11 = new ParserSymbol("string", 11);
			$symbol12 = new ParserSymbol("COLUMN_EMPTY", 12);
			$symbol13 = new ParserSymbol("COLUMN_STRING", 13);
			$symbol14 = new ParserSymbol("CHAR", 14);
			$symbol15 = new ParserSymbol("QUOTE_ON", 15);
			$symbol16 = new ParserSymbol("QUOTE_OFF", 16);
			...
			$this->symbols["grid"] = $symbol3;
			$this->symbols[4] = $symbol4;
			$this->symbols["rows"] = $symbol4;
			$this->symbols[5] = $symbol5;
			$this->symbols["EOF"] = $symbol5;
			$this->symbols[6] = $symbol6;
			$this->symbols["row"] = $symbol6;
			$this->symbols[7] = $symbol7;
			$this->symbols["END_OF_LINE"] = $symbol7;
			$this->symbols[8] = $symbol8;
			$this->symbols["END_OF_LINE_WITH_EMPTY_NEXT_FIRST_COLUMN"] = $symbol8;
			$this->symbols[9] = $symbol9;
			$this->symbols["END_OF_LINE_WITH_NO_COLUMNS"] = $symbol9;
			$this->symbols[10] = $symbol10;
			$this->symbols["END_OF_LINE_WITH_EMPTY_COLUMN"] = $symbol10;
			$this->symbols[11] = $symbol11;
			$this->symbols["string"] = $symbol11;
			$this->symbols[12] = $symbol12;
			$this->symbols["COLUMN_EMPTY"] = $symbol12;
			$this->symbols[13] = $symbol13;
			$this->symbols["COLUMN_STRING"] = $symbol13;
			$this->symbols[14] = $symbol14;
			$this->symbols["CHAR"] = $symbol14;
			$this->symbols[15] = $symbol15;
			$this->symbols["QUOTE_ON"] = $symbol15;
			$this->symbols[16] = $symbol16;
			$this->symbols["QUOTE_OFF"] = $symbol16;
			...
			$tableDefinition0 = array(
					...
					11=>new ParserAction($this->none, $table9),
			...
			$tableDefinition2 = array(
					...
					5=>new ParserAction($this->shift, $table14),
					7=>new ParserAction($this->shift, $table15),
					8=>new ParserAction($this->shift, $table16),
					9=>new ParserAction($this->shift, $table17),
					10=>new ParserAction($this->shift, $table18)
				);
			...
			$tableDefinition4 = array(
					...
					10=>new ParserAction($this->reduce, $table3),
					12=>new ParserAction($this->shift, $table19),
					13=>new ParserAction($this->shift, $table20)
				);
			...
			$tableDefinition9 = array(
					...
					14=>new ParserAction($this->shift, $table21)
				);
			...
			$tableDefinition13 = array(
					...
					11=>new ParserAction($this->none, $table22),
					14=>new ParserAction($this->shift, $table12),
					15=>new ParserAction($this->shift, $table13)
				);
			...
			$tableDefinition15 = array(
					...
					6=>new ParserAction($this->none, $table23),
			...
			$tableDefinition16 = array(
					...
					6=>new ParserAction($this->none, $table24),
			...
			$tableDefinition17 = array(
					...
					6=>new ParserAction($this->none, $table25),
			...
			$tableDefinition18 = array(
					...
					6=>new ParserAction($this->none, $table26),
			...
			$tableDefinition19 = array(
					...
					11=>new ParserAction($this->none, $table27),
			...
			$tableDefinition20 = array(
					...
					11=>new ParserAction($this->none, $table28),
			...
			$tableDefinition22 = array(
					...
					14=>new ParserAction($this->shift, $table21),
					16=>new ParserAction($this->shift, $table29)
				);
			...
			$this->defaultActions = array(
					...
					14=>new ParserAction($this->reduce, $table1)
				);
			...
			$this->productions = array(
					...
					8=>new ParserProduction($symbol4,2),
					9=>new ParserProduction($symbol4,2),
					10=>new ParserProduction($symbol4,2),
					11=>new ParserProduction($symbol4,2),
					12=>new ParserProduction($symbol4,3),
					...
					19=>new ParserProduction($symbol6,3),
					...
					24=>new ParserProduction($symbol11,2),
					25=>new ParserProduction($symbol11,3)
				);
        ...
        //Setup Lexer
			...
			$this->conditions = array(
					...
					"BOF"=>new LexerConditions(array( 4,6,7,14,15,16,17,18,19,20), true),
					"PRE_QUOTE"=>new LexerConditions(array( 5,6,7,15,16,17,18,19,20), true),
					"QUOTE"=>new LexerConditions(array( 0,1,2,3,6,7,8,15,16,17,18,19,20), true),
					"STRING"=>new LexerConditions(array( 6,7,9,10,11,12,13,15,16,17,18,19,20), true),
					"INITIAL"=>new LexerConditions(array( 6,7,15,16,17,18,19,20), true)
				);
...
case 9:
            ...
            $s[$o-1]->text->addRow(new TableRow());
...
case 11:
            ...
            $s[$o-1]->text->rows[$s[$o-1]->length - 1]->addColumn();
...
case 14:
            ...
            $s[$o-2]->text->addRow(new TableRow());
            $s[$o-2]->text->addRow($s[$o]);
...
case 15:
            ...
            $s[$o-2]->text->rows[$s[$o-2]->length - 1]->addColumn();
            $s[$o-2]->text->addRow($s[$o]);
...
case 19:
            ...
            $s[$o-2]->text->addColumn();
            $s[$o-2]->text->addColumn($s[$o]);
...
case 2:
    //<QUOTE>('"'|'"')
        ...
        if ($this->yy->text == $this->quoteChar) {
            $this->popState();
            $this->begin('STRING');
            return 16;
        } else {
...
case 4:
    //<BOF>('"'|"'")
        ...
        $this->popState();
        $this->quoteChar = $this->yy->text->text;
        $this->begin('QUOTE');
        return 15;
