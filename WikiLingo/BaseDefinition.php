...
break;
case 2:
		return $s[$o-1] + $s[$o]; return $s[$o-1] . ($s[$o] == "\n" ? $this->line($s[$o]) : $s[$o]);
...
break;
case 7:
	    $thisS = parser.block($s[$o-1]);  $thisS = $this->block($s[$o-1]);
	
break;
case 8:
        $thisS = parser.block($s[$o-2] + $s[$o-1]);  $thisS = $this->block($s[$o-2] . $s[$o-1]);
...
break;
case 13:
        $thisS = parser.comment($s[$o]);  $thisS = $this->comment($s[$o]);
...
break;
case 16:
        $thisS = parser.noParse($s[$o-1]);  $thisS = $this->noParse($s[$o-1]);
...
break;
case 19:
        $thisS = parser.preFormattedText($s[$o-1]);  $thisS = $this->preFormattedText($s[$o-1]);
    
break;
case 20:
        $thisS = parser.doubleDynamicVar($s[$o]);  $thisS = $this->doubleDynamicVar($s[$o]);
    
break;
case 21:
        $thisS = parser.singleDynamicVar($s[$o]);  $thisS = $this->singleDynamicVar($s[$o]);
     
break;
case 22:
        $thisS = parser.argumentVar($s[$o]);  $thisS = $this->argumentVar($s[$o]);
    
break;
case 23:
        $thisS = parser.htmlTag($s[$o]);  $thisS = $this->htmlTag($s[$o]);
    
break;
case 24:
		$thisS = parser.hr();  $thisS = $this->hr();
...
break;
case 27:
		$thisS = parser.bold($s[$o-1]);  $thisS = $this->bold($s[$o-1]);
...
break;
case 30:
		$thisS = parser.box($s[$o-1]);  $thisS = $this->box($s[$o-1]);
...
break;
case 33:
		$thisS = parser.center($s[$o-1]);  $thisS = $this->center($s[$o-1]);
...
break;
case 36:
		$thisS = parser.code($s[$o-1]);  $thisS = $this->code($s[$o-1]);
...
break;
case 39:
		$thisS = parser.color($s[$o-1]);  $thisS = $this->color($s[$o-1]);
...
break;
case 42:
		$thisS = parser.italic($s[$o-1]);  $thisS = $this->italic($s[$o-1]);
	
break;
case 44:
        $thisS = parser.unlink($s[$o-1] + $s[$o]);  $thisS = $this->unlink($s[$o-1] . $s[$o]);
    
break;
case 45:
		$thisS = parser.unlink($s[$o-2] + $s[$o-1] + $s[$o]);  $thisS = $this->unlink($s[$o-2] . $s[$o-1] . $s[$o]);
...
break;
case 48:
		$thisS = parser.link($s[$o-2], $s[$o-1]);  $thisS = $this->link($s[$o-2], $s[$o-1]);
...
break;
case 51:
		$thisS = parser.strike($s[$o-1]);  $thisS = $this->strike($s[$o-1]);
	
break;
case 52:
        $thisS = parser.doubleDash();  $thisS = $this->doubleDash();
    
break;
case 54:
        $thisS = parser.tableParser($s[$o-1] + $s[$o], true);  $thisS = $this->tableParser($s[$o-1] . $s[$o], true);
    
break;
case 55:
		$thisS = parser.tableParser($s[$o-1]);  $thisS = $this->tableParser($s[$o-1]);
...
break;
case 58:
		$thisS = parser.titleBar($s[$o-1]);  $thisS = $this->titleBar($s[$o-1]);
...
break;
case 61:
		$thisS = parser.underscore($s[$o-1]);  $thisS = $this->underscore($s[$o-1]);
	
break;
case 63:
        $thisS = $s[$o-1]['syntax'] + $s[$o]; $thisS = $s[$o-1]['syntax'] . $s[$o];
    
break;
case 64:
		$thisS = parser.link($s[$o-2]['type'], $s[$o-1]);  $thisS = $this->link($s[$o-2]['type'], $s[$o-1]);
	
break;
case 65:
        $thisS = parser.link('word', $s[$o]);  $thisS = $this->link('word', $s[$o]);
    
break;
case 66:
 		$thisS = parser.plugin($s[$o]);  $thisS = $this->plugin($s[$o]);
...
break;
case 69:
 		$s[$o].body = $s[$o-1];  $s[$o]['body'] = $s[$o-1];
 		 $thisS = $this->plugin($s[$o]);
 	
break;
case 70:
        $thisS = parser.line($s[$o]);  $thisS = $this->line($s[$o]);
    
break;
case 71:
        $thisS = parser.forcedLineEnd();  $thisS = $this->forcedLineEnd();
    
break;
case 72:
        $thisS = parser.char($s[$o]);  $thisS = $this->char($s[$o]);
...
case 0:
		lexer.conditionStack = [];  $this->conditionStackCount = 0;
...
break;
case 1:
		if (parser.npStack != true) return 11;  if ($this->npStack != true) return 11;
		 $this->popState();
		 $this->npStack = false;
...
break;
case 2:
		if (parser.isContent()) return 11;  if ($this->isContent()) return 11;
		 $this->begin('np');
		 $this->npStack = true;
...
break;
case 4:
		if (parser.ppStack != true) return 11;  if ($this->ppStack != true) return 11;
		 $this->popState();
		 $this->ppStack = false;
...
break;
case 9:
        if (parser.isContent(['linkStack'])) return 11;  if ($this->isContent(array('linkStack'))) return 11;
...
break;
case 14:
		if (parser.npStack || parser.ppStack) return 11;  if ($this->npStack == true || $this->ppStack) return 11;
...
break;
case 16:
		var plugin = yy->pluginStack[yy->pluginStack.length - 1];  $plugin = end($this->pluginStack);
...
break;
case 20:
		if (parser.isContent() || parser.tableStack) return 11;  if ($this->isContent() || !empty($this->tableStack)) return 11;
		 return 53;
...
break;
case 67:
		return 20;  if (JisonParser_Html_Handler::isHtmlTag($yy_->yytext)) {
		   return 20;
		 }
		 $tag = $yy_->yytext;
