...
class Definition extends Base
{
    ...
    function __construct()
    {
        //Setup Parser
			...
			$symbol58 = new ParserSymbol("WHITE_SPACE", 58);
			$symbol59 = new ParserSymbol("PRE_BLOCK_START", 59);
			$symbol60 = new ParserSymbol("BLOCK_START", 60);
			$symbol61 = new ParserSymbol("BLOCK_END", 61);
			...
			$this->symbols["WHITE_SPACE"] = $symbol58;
			$this->symbols[59] = $symbol59;
			$this->symbols["PRE_BLOCK_START"] = $symbol59;
			$this->symbols[60] = $symbol60;
			$this->symbols["BLOCK_START"] = $symbol60;
			$this->symbols[61] = $symbol61;
			$this->symbols["BLOCK_END"] = $symbol61;
			...
			$tableDefinition0 = array(
					...
					59=>new ParserAction($this->shift, $table37)
				);
			...
			$tableDefinition2 = array(
					...
					5=>new ParserAction($this->shift, $table38),
					6=>new ParserAction($this->none, $table39),
					7=>new ParserAction($this->shift, $table5),
					8=>new ParserAction($this->shift, $table6),
					10=>new ParserAction($this->shift, $table7),
					12=>new ParserAction($this->shift, $table8),
			...
			$tableDefinition6 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table7)
				);
			...
			$tableDefinition7 = array(
					...
					10=>new ParserAction($this->shift, $table7),
					11=>new ParserAction($this->shift, $table42),
					12=>new ParserAction($this->shift, $table8),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table10)
				);
			...
			$tableDefinition8 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table13)
				);
			...
			$tableDefinition14 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table21)
				);
			...
			$tableDefinition15 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table25)
				);
			...
			$tableDefinition16 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table29)
				);
			...
			$tableDefinition17 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table33)
				);
			...
			$tableDefinition18 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table37)
				);
			...
			$tableDefinition19 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table41)
				);
			...
			$tableDefinition20 = array(
					...
					31=>new ParserAction($this->shift, $table20),
					32=>new ParserAction($this->shift, $table59),
					33=>new ParserAction($this->shift, $table21),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table45)
				);
			...
			$tableDefinition21 = array(
					...
					33=>new ParserAction($this->shift, $table21),
					34=>new ParserAction($this->shift, $table61),
					35=>new ParserAction($this->shift, $table22),
					36=>new ParserAction($this->shift, $table23),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table49)
				);
			...
			$tableDefinition23 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table54)
				);
			...
			$tableDefinition24 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table58)
				);
			...
			$tableDefinition25 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table62)
				);
			...
			$tableDefinition26 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table66)
				);
			...
			$tableDefinition27 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table70)
				);
			...
			$tableDefinition28 = array(
					...
					46=>new ParserAction($this->shift, $table28),
					47=>new ParserAction($this->shift, $table73),
					48=>new ParserAction($this->shift, $table29),
					49=>new ParserAction($this->shift, $table30),
					51=>new ParserAction($this->shift, $table31),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table74)
				);
			...
			$tableDefinition29 = array(
					...
					61=>new ParserAction($this->reduce, $table78)
				);

			$tableDefinition30 = array(
				
					1=>new ParserAction($this->reduce, $table79),
					4=>new ParserAction($this->none, $table74),
					...
					48=>new ParserAction($this->shift, $table29),
					49=>new ParserAction($this->shift, $table30),
					50=>new ParserAction($this->shift, $table75),
					51=>new ParserAction($this->shift, $table31),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table79)
				);
			...
			$tableDefinition31 = array(
					...
					52=>new ParserAction($this->shift, $table76),
			...
			$tableDefinition34 = array(
					...
					61=>new ParserAction($this->reduce, $table88)
				);
			...
			$tableDefinition37 = array(
					...
					54=>new ParserAction($this->reduce, $table95),
					...
					60=>new ParserAction($this->shift, $table77),
			...
			$tableDefinition41 = array(
					...
					7=>new ParserAction($this->shift, $table5),
					8=>new ParserAction($this->shift, $table6),
					9=>new ParserAction($this->shift, $table78),
					10=>new ParserAction($this->shift, $table7),
					12=>new ParserAction($this->shift, $table8),
					14=>new ParserAction($this->shift, $table9),
					15=>new ParserAction($this->shift, $table10),
			...
			$tableDefinition45 = array(
					...
					10=>new ParserAction($this->shift, $table7),
					12=>new ParserAction($this->shift, $table8),
					13=>new ParserAction($this->shift, $table80),
					14=>new ParserAction($this->shift, $table9),
					15=>new ParserAction($this->shift, $table10),
					16=>new ParserAction($this->shift, $table11),
					17=>new ParserAction($this->shift, $table12),
			...
			$tableDefinition46 = array(
					...
					18=>new ParserAction($this->shift, $table13),
					19=>new ParserAction($this->shift, $table14),
					20=>new ParserAction($this->shift, $table81),
					21=>new ParserAction($this->shift, $table15),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table22)
				);
			...
			$tableDefinition48 = array(
					...
					21=>new ParserAction($this->shift, $table15),
					22=>new ParserAction($this->shift, $table82),
					23=>new ParserAction($this->shift, $table16),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table26)
				);
			...
			$tableDefinition50 = array(
					...
					23=>new ParserAction($this->shift, $table16),
					24=>new ParserAction($this->shift, $table83),
					25=>new ParserAction($this->shift, $table17),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table30)
				);
			...
			$tableDefinition52 = array(
					...
					25=>new ParserAction($this->shift, $table17),
					26=>new ParserAction($this->shift, $table84),
					27=>new ParserAction($this->shift, $table18),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table34)
				);
			...
			$tableDefinition54 = array(
					...
					27=>new ParserAction($this->shift, $table18),
					28=>new ParserAction($this->shift, $table85),
					29=>new ParserAction($this->shift, $table19),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table38)
				);
			...
			$tableDefinition56 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table42)
				);
			...
			$tableDefinition58 = array(
					...
					31=>new ParserAction($this->shift, $table20),
					32=>new ParserAction($this->shift, $table87),
					33=>new ParserAction($this->shift, $table21),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table46)
				);
			...
			$tableDefinition60 = array(
					...
					33=>new ParserAction($this->shift, $table21),
					34=>new ParserAction($this->shift, $table88),
					35=>new ParserAction($this->shift, $table22),
					36=>new ParserAction($this->shift, $table23),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table50)
				);
			...
			$tableDefinition62 = array(
					...
					35=>new ParserAction($this->shift, $table22),
					36=>new ParserAction($this->shift, $table23),
					37=>new ParserAction($this->shift, $table89),
					38=>new ParserAction($this->shift, $table24),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table55)
				);
			...
			$tableDefinition64 = array(
					...
					38=>new ParserAction($this->shift, $table24),
					39=>new ParserAction($this->shift, $table90),
					40=>new ParserAction($this->shift, $table25),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table59)
				);
			...
			$tableDefinition66 = array(
					...
					40=>new ParserAction($this->shift, $table25),
					41=>new ParserAction($this->shift, $table91),
					42=>new ParserAction($this->shift, $table26),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table63)
				);
			...
			$tableDefinition68 = array(
					...
					42=>new ParserAction($this->shift, $table26),
					43=>new ParserAction($this->shift, $table92),
					44=>new ParserAction($this->shift, $table27),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table67)
				);
			...
			$tableDefinition70 = array(
					...
					44=>new ParserAction($this->shift, $table27),
					45=>new ParserAction($this->shift, $table93),
					46=>new ParserAction($this->shift, $table28),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table71)
				);
			...
			$tableDefinition72 = array(
					...
					46=>new ParserAction($this->shift, $table28),
					47=>new ParserAction($this->shift, $table94),
					48=>new ParserAction($this->shift, $table29),
					49=>new ParserAction($this->shift, $table30),
					51=>new ParserAction($this->shift, $table31),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table75)
				);
			...
			$tableDefinition76 = array(
					...
					4=>new ParserAction($this->none, $table95),
					...
					49=>new ParserAction($this->shift, $table30),
					51=>new ParserAction($this->shift, $table31),
					53=>new ParserAction($this->shift, $table96),
					54=>new ParserAction($this->shift, $table32),
					55=>new ParserAction($this->shift, $table33),
					56=>new ParserAction($this->shift, $table34),
					57=>new ParserAction($this->shift, $table35),
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->reduce, $table84)
				);

			$tableDefinition77 = array(
				
					1=>new ParserAction($this->reduce, $table94),
					4=>new ParserAction($this->none, $table98),
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->shift, $table97)
				);
			...
			$tableDefinition95 = array(
					...
					49=>new ParserAction($this->shift, $table30),
					51=>new ParserAction($this->shift, $table31),
					53=>new ParserAction($this->shift, $table99),
					54=>new ParserAction($this->shift, $table32),
					55=>new ParserAction($this->shift, $table33),
					56=>new ParserAction($this->shift, $table34),
					57=>new ParserAction($this->shift, $table35),
			...
			$tableDefinition96 = array(
					...
					61=>new ParserAction($this->reduce, $table83)
				);
			...
			$tableDefinition98 = array(
					...
					58=>new ParserAction($this->shift, $table36),
					59=>new ParserAction($this->shift, $table37),
					61=>new ParserAction($this->shift, $table100)
				);
			...
			$tableDefinition100 = array(
					...
					54=>new ParserAction($this->reduce, $table92),
			...
			$this->defaultActions = array(
					...
					38=>new ParserAction($this->reduce, $table2)
				);
			...
			$this->productions = array(
					...
					92=>new ParserProduction($symbol6,4),
					93=>new ParserProduction($symbol6,3),
					94=>new ParserProduction($symbol6,2),
					95=>new ParserProduction($symbol6,1)
				);
