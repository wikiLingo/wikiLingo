    ...
    function __construct()
    {
        //Setup Parser
			...
			$tableDefinition62 = array(
					...
					37=>new ParserAction($this->shift, $table23),
					38=>new ParserAction($this->shift, $table24),
					39=>new ParserAction($this->shift, $table84),
					40=>new ParserAction($this->shift, $table25),
					42=>new ParserAction($this->shift, $table26),
					44=>new ParserAction($this->shift, $table27),
					46=>new ParserAction($this->shift, $table28),
			...
			$tableDefinition64 = array(
					...
					38=>new ParserAction($this->shift, $table24),
					40=>new ParserAction($this->shift, $table25),
					41=>new ParserAction($this->shift, $table85),
					42=>new ParserAction($this->shift, $table26),
					44=>new ParserAction($this->shift, $table27),
					46=>new ParserAction($this->shift, $table28),
					47=>new ParserAction($this->shift, $table29),
			...
			$tableDefinition70 = array(
					...
					4=>new ParserAction($this->none, $table88),
					...
					47=>new ParserAction($this->shift, $table29),
					49=>new ParserAction($this->shift, $table30),
					51=>new ParserAction($this->shift, $table89),
					52=>new ParserAction($this->shift, $table31),
					53=>new ParserAction($this->shift, $table32),
					54=>new ParserAction($this->shift, $table33),
					55=>new ParserAction($this->shift, $table34),
			...
			$tableDefinition71 = array(
					...
					4=>new ParserAction($this->none, $table91),
					...
					54=>new ParserAction($this->shift, $table33),
					55=>new ParserAction($this->shift, $table34),
					57=>new ParserAction($this->shift, $table90)
				);
			...
			$tableDefinition88 = array(
					...
					47=>new ParserAction($this->shift, $table29),
					49=>new ParserAction($this->shift, $table30),
					51=>new ParserAction($this->shift, $table92),
					52=>new ParserAction($this->shift, $table31),
					53=>new ParserAction($this->shift, $table32),
					54=>new ParserAction($this->shift, $table33),
					55=>new ParserAction($this->shift, $table34)
			...
			$tableDefinition91 = array(
					...
					54=>new ParserAction($this->shift, $table33),
					55=>new ParserAction($this->shift, $table34),
					57=>new ParserAction($this->shift, $table93)
				);
			...
			$this->productions = array(
					...
					47=>new ParserProduction($symbol6,3),
					...
					60=>new ParserProduction($symbol6,3),
					61=>new ParserProduction($symbol6,1),
					62=>new ParserProduction($symbol6,1),
					63=>new ParserProduction($symbol6,2),
					64=>new ParserProduction($symbol6,4),
        ...
        //Setup Lexer
			...
			$this->conditions = array(
					...
					"BOF"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,24,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"np"=>new LexerConditions(array( 0,1,2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"pp"=>new LexerConditions(array( 2,3,4,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"tc"=>new LexerConditions(array( 2,5,6,7,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"pluginStart"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,16,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"plugin"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,18,19,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"inlinePlugin"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,14,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"line"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"preBlock"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,21,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"block"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,20,22,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"preBlockEnd"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"bold"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,28,29,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"box"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,31,32,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"center"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,34,35,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"code"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,37,38,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"color"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,40,41,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"italic"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,43,44,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"unlink"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,46,47,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"link"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,49,50,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"strike"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,52,53,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"table"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,56,57,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"titleBar"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,59,60,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"underscore"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,62,63,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"wikiLink"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true),
					"INITIAL"=>new LexerConditions(array( 2,5,8,9,10,11,12,13,15,17,23,25,26,27,30,33,36,39,42,45,48,51,54,55,58,61,64,67,68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94), true)
				);
